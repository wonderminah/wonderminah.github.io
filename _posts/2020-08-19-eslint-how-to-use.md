...
# 사용예시
## 문제 패턴을 식별한 경우
![image-20200819233603148](../assets/img/image-20200819233603148.png)
...
![image-20200819233924160](../assets/img/image-20200819233924160.png)

## 제시된 규칙을 따르지 않고 무시하고 싶을 경우
아래와 같은 디렉토리 위치에 .eslintrc.json 파일을 생성 후, "rules" object에 "no-use-before-define" property를 0으로 설정한다.
![image-20200819234253233](../assets/img/image-20200819234253233.png)
